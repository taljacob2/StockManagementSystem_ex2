...
/**
 * This class <i>wraps</i> a {@code double} number as a {@link DoubleProperty}.
 * The class is mainly used for {@code binding} a <tt>JavaFX</tt> {@code
 * Property} to a {@code double} number.
 */
